...
export const fibonacciCards: CardConfig[] = [
  ...
  { value: 5, displayValue: '5', color: '#9EC8FE' },
  { value: 8, displayValue: '8', color: '#9EC8FE' },
  { value: 13, displayValue: '13', color: '#9EC8FE' },
  { value: 21, displayValue: '21', color: '#9EC8FE' },
  { value: 34, displayValue: '34', color: '#9EC8FE' },
  { value: 55, displayValue: '55', color: '#9EC8FE' },
  { value: 89, displayValue: '89', color: '#9EC8FE' },
  { value: -2, displayValue: '❓', color: '#9EC8FE' },
...
export const shortFibonacciCards: CardConfig[] = [
  ...
  { value: 8, displayValue: '8', color: '#9EC8FE' },
  { value: 13, displayValue: '13', color: '#9EC8FE' },
  { value: 21, displayValue: '20', color: '#9EC8FE' },
  { value: 34, displayValue: '40', color: '#9EC8FE' },
  { value: 55, displayValue: '100', color: '#9EC8FE' },
  { value: -2, displayValue: '❓', color: '#9EC8FE' },
  { value: -1, displayValue: '-1', color: 'var(--color-background-secondary)' },
];
...
export const tShirtCards: CardConfig[] = [
  ...
  { value: 60, displayValue: 'XL', color: '#F39893' },
  { value: 70, displayValue: 'XXL', color: '#F39893' },
  { value: -2, displayValue: '❓', color: '#9EC8FE' },
  { value: -1, displayValue: '-1', color: 'var(--color-background-secondary)' },
];
